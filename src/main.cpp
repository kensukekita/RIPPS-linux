...
const string strMessageMagic = "RIPPS Signed Message:\n";
...
if(nBestHeight < 10000) 
	{
        nSubsidy = nCoinAge * COIN_YEAR_REWARD25 * 33 / (365 * 33 + 8); // 25%
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RIPPS", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "sweet 25 dreams are made of this 2017";
        CTransaction txNew;
        txNew.nTime = 1509561288;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1509561288;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2455953 : 2455953;
        ...
        assert(block.hashMerkleRoot == uint256("0xc0402dc91af6e690b6ee6b38432c00a389aeb293b8ce20a987a7c6d2077a5af0"));
...
unsigned char pchMessageStart[4] = { 0xec, 0x2d, 0x1c, 0xd4 };
