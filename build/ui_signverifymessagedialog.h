...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->setStyleSheet(QString::fromUtf8("background-image: url(:/images/bkg2);"));
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this EDDIE address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified EDDIE address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
